...
(function() {
  var defer, findClosestElementFromNode, nodeIsBlockStartComment, nodeIsEmptyTextNode, normalizeSpaces, summarizeStringChange, tagName,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  defer = Trix.defer, findClosestElementFromNode = Trix.findClosestElementFromNode, nodeIsEmptyTextNode = Trix.nodeIsEmptyTextNode, nodeIsBlockStartComment = Trix.nodeIsBlockStartComment, normalizeSpaces = Trix.normalizeSpaces, summarizeStringChange = Trix.summarizeStringChange, tagName = Trix.tagName;
...
(function() {
  var dataTransferIsPlainText, dataTransferIsWritable, defer, extensionForFile, findClosestElementFromNode, findElementFromContainerAndOffset, handleEvent, innerElementIsActive, keyEventIsKeyboardCommand, keyEventIsPasteAndMatchStyleShortcut, keyEventIsWebInspectorShortcut, makeElement, objectsAreEqual, pasteEventIsCrippledSafariHTMLPaste, summarizeStringChange, tagName, testTransferData,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  handleEvent = Trix.handleEvent, findClosestElementFromNode = Trix.findClosestElementFromNode, findElementFromContainerAndOffset = Trix.findElementFromContainerAndOffset, defer = Trix.defer, makeElement = Trix.makeElement, innerElementIsActive = Trix.innerElementIsActive, summarizeStringChange = Trix.summarizeStringChange, objectsAreEqual = Trix.objectsAreEqual, tagName = Trix.tagName;
  ...
  Trix.InputController = (function(superClass) {
    ...
    InputController.prototype.mutationIsExpected = function(arg) {
      ...
      if (singleUnexpectedNewline) {
        if (range = this.getSelectedRange()) {
          offset = unexpectedNewlineAddition ? -1 : 1;
    ...
    InputController.prototype.events = {
      ...
      paste: function(event) {
        var extension, file, href, html, paste, pasteData, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, string;
        ...
        if (dataTransferIsPlainText(paste)) {
          ...
          if ((ref7 = this.delegate) != null) {
            ref7.inputControllerWillPasteText(pasteData);
          }
          if ((ref8 = this.responder) != null) {
            ref8.insertText(Trix.Text.textForStringWithAttributes(href, {
              href: href
            }));
          }
          this.requestRender();
          if ((ref9 = this.delegate) != null) {
            ref9.inputControllerDidPaste(pasteData);
          }
        } else if (indexOf.call(paste.types, "Files") >= 0) {
          if (file = (ref10 = paste.items) != null ? (ref11 = ref10[0]) != null ? typeof ref11.getAsFile === "function" ? ref11.getAsFile() : void 0 : void 0 : void 0) {
            ...
            if ((ref13 = this.responder) != null) {
              ref13.insertFile(file);
            }
            this.requestRender();
            if ((ref14 = this.delegate) != null) {
              ref14.inputControllerDidPaste(pasteData);
            }
          }
        }
        return event.preventDefault();
...
(function() {
  ...
  Trix.PreviewableAttachmentView = (function(superClass) {
    ...
    PreviewableAttachmentView.prototype.attachmentDidChangePreviewURL = function() {
      this.refresh(this.image);
      return this.refresh();
    };
...
(function() {
  ...
  Trix.Composition = (function(superClass) {
    ...
    Composition.prototype.deleteInDirection = function(direction) {
      var attachment, block, deletingIntoPreviousBlock, offset, range, selectionIsCollapsed;
      range = this.getSelectedRange();
      selectionIsCollapsed = rangeIsCollapsed(range);
      block = this.getBlock();
      if (selectionIsCollapsed && direction === "backward") {
        offset = this.document.locationFromPosition(range[0]).offset;
        deletingIntoPreviousBlock = offset === 0;
      }
...
(function() {
  ...
  Trix.EditorController = (function(superClass) {
    ...
    EditorController.prototype.compositionDidChangeAttachmentPreviewURL = function(attachment) {
      return this.compositionController.invalidateViewForObject(attachment);
    };
    ...
    EditorController.prototype.inputControllerDidPaste = function(pasteData) {
      ...
      this.pasting = null;
      return this.editorElement.notify("paste", {
        pasteData: pasteData,
        range: range
      });
    };
